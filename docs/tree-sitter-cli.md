...
compilar los parsers que usa la configuración: no compila él mismo, ejecuta `tree-sitter build`, y es
esa orden la que llama al [Compilador de C](/docs/Compilador%20de%20C.md).
